...
Here we rename indices for the use with English speakers and organize measured dimensions.
...
ds3 %>% readr::write_rds("../../data-private/derived/university-ranking/1-scribe-ds3.rds")
ds3 %>% readr::write_csv("../../data-private/derived/university-ranking/1-scribe-ds3.csv")
```
