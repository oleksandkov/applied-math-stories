...
Also, lowest value of *"qs_rank"* is 7
...
4.  The universities which have higher rate of **QS rate** than 7 (On graph show as a squares, the higher rate it have the bigger square is)
5.  The number of students who studying there (On graph the more visible object the more students studying there)
