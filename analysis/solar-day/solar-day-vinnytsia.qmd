...
ggplot(data = march, aes(x = as.numeric(Year), y = Daylength_numeric_march)) + 
  ...
  annotate("text", x = 7, y = 12,label = paste("Difference:", difference, "hours"), color = "black", size = 3.5, fontface = "plain") +
  labs(
...
ggplot(data = june, aes(x = as.numeric(Year), y = Daylength_numeric_june)) + 
  geom_line(color = "#1f78b4", size = 1) + 
  geom_point(color = "black", size = 2) +
  annotate("text", x = 20, y = 16.10,label = paste("Difference:", difference_june, "hours"), color = "black", size = 3.5, fontface = "plain") +
  labs(
